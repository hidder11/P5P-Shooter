    ...
    extend(ease, {
        ...
        cache: {
            ...
            inOutQuint: function(t) {
                return t < .5 ? 16 * t * t * t * t * t : 1 + 16 * (--t) * t *
                    t * t * t;
            },
            inSine: function(t) {
        ...
        insertIntermediateValues: function(a) {
            ...
            for (var i = 0; i < a.length; i++) {
                ...
                if (i < a.length - 1) result.push(a[i + 1] + (a[i] - a[i + 1]) *
                    0.6);
            }
        ...
        spline: function(x, key) {
            ...
            if (!this.splineK[key]) {
                ...
                for (var i = 0; i < ys.length; i++) xs.push(i *
                    (1 / (ys.length - 1)));
    ...
    defaults: function() {
        ...
        for (var i = 1; i < arguments.length; i++) {
            ...
            for (var j in arguments[i]) {
                ...
                if (typeof arguments[0][j] ===
                    'undefined') arguments[0][j] = arguments[i][j];
...
PLAYGROUND.Events.prototype = {
    ...
    trigger: function(event, data) {
        ...
        if (this.listeners['event']) {
            ...
            for (var i = 0, len = this.listeners['event'].length; i <
            len; i++) {
...
PLAYGROUND.Utils.extend(PLAYGROUND.States.prototype,
    PLAYGROUND.Events.prototype);
...
PLAYGROUND.Application = function(args) {
    ...
    if (typeof this.container ===
        'string') this.container = document.querySelector(this.container);

    if (args.background !==
        false) this.container.style.background = this.background;
    ...
    function onPreloadEnd() {
        ...
        setTimeout(function() {
            ...
            if (PLAYGROUND.LoadingScreen) app.setState(
...
PLAYGROUND.Application.prototype = {
    ...
    emitLocalEvent: function(event, data) {
        ...
        if ((event !== 'render' || !this.skipEvents || this.loader.ready) &&
    ...
    emitGlobalEvent: function(event, data) {
        ...
        if ((event !== 'render' || !this.skipEvents || this.loader.ready) &&
            this.event) this.event(event, data);
    ...
    updateSize: function() {
        ...
        if (!this.autoScale && !this.autoWidth && !this.autoHeight) {
            ...
            this.scale = Math.min(containerWidth / this.width, containerHeight /
                this.height);
    ...
    loadDataItem: function(name) {
        ...
        this.request(entry.url + (this.purgeCache ? ('?' + Date.now()) : '')).
            then(processData);
    ...
    loadImages: function() {
        ...
        for (var i = 0; i < arguments.length; i++) {
            ...
            if (typeof arg === 'object') {
                ...
                for (var key in arg) promises = promises.concat(
                    this.loadImages(arg[key]));
...
PLAYGROUND.Utils.extend(PLAYGROUND.Application.prototype,
    PLAYGROUND.Events.prototype);
...
PLAYGROUND.Utils.extend(PLAYGROUND.Gamepads.prototype,
    PLAYGROUND.Events.prototype);
...
PLAYGROUND.Keyboard.prototype = {
    ...
    keydown: function(e) {
        ...
        if (e.which >= 48 && e.which <= 90) var keyName = String.fromCharCode(
            e.which).toLowerCase();
        ...
        if (keyName === this.lastKey && Date.now() - this.timestamps[keyName] <
            this.doubleTimeframe * 1000) {
...
PLAYGROUND.Utils.extend(PLAYGROUND.Keyboard.prototype,
    PLAYGROUND.Events.prototype);
...
PLAYGROUND.Pointer.prototype = {
    ...
    pointerdown: function(e) {
        ...
        if (timeFrame < 0.4 && pointer.tapPosition &&
    ...
    pointermove: function(e) {
        ...
        if (!pointer.dragging && pointer.pressed &&
...
PLAYGROUND.Utils.extend(PLAYGROUND.Loader.prototype,
    PLAYGROUND.Events.prototype);
...
PLAYGROUND.Mouse = function(app, element) {
    ...
    if (app.mouseThrottling) {
        ...
        this.mousemove = PLAYGROUND.Utils.throttle(this.mousemove,
            app.mouseThrottling);
...
PLAYGROUND.Mouse.prototype = {
    ...
    mousemove: function(e) {
        ...
        this.x = this.mousemoveEvent.x = (e.pageX - this.elementOffset.x -
            this.app.offsetX) / this.app.scale | 0;
        this.y = this.mousemoveEvent.y = (e.pageY - this.elementOffset.y -
            this.app.offsetY) / this.app.scale | 0;
    ...
    enableMousewheel: function() {
        ...
        var eventNames = 'onwheel' in document || document.documentMode >= 9
            ? ['wheel']
            : [
                'mousewheel',
                'DomMouseScroll',
        ...
        for (var i = eventNames.length; i;) {
            ...
            self.element.addEventListener(eventNames[--i], function(event) {
                ...
                var prevent = !PLAYGROUND.Utils.classInParents(event.target,
                    'scroll');
...
PLAYGROUND.Utils.extend(PLAYGROUND.Mouse.prototype,
    PLAYGROUND.Events.prototype);
            ...
            (function(global) {
                ...
                StereoPannerImpl.prototype.connect = function(destination) {
                    ...
                    if (!this._isConnected) {
                        ...
                        this._dc1buffer = audioContext.createBuffer(1, 2,
                    ...
                    global.AudioNode.prototype.connect.call(this.outlet,
                        destination);
                };
...
PLAYGROUND.SoundWebAudioAPI.prototype = {
    ...
    load: function(file) {
        ...
        request.onload = function() {
            ...
            sampler.context.decodeAudioData(this.response,
    ...
    step: function(delta) {
        ...
        for (var i = 0; i < this.loops.length; i++) {
            ...
            if (loop.fadeIn) {
                ...
                volume = this.setVolume(loop,
                    Math.min(1.0, volume + delta * 0.5));
...
PLAYGROUND.Touch.prototype = {
    ...
    touchmove: function(e) {
        ...
        for (var i = 0; i < e.changedTouches.length; i++) {
            ...
            this.x = touchmoveEvent.x = (touch.pageX - this.elementOffset.x -
                this.app.offsetX) / this.app.scale | 0;
            this.y = touchmoveEvent.y = (touch.pageY - this.elementOffset.y -
                this.app.offsetY) / this.app.scale | 0;
    ...
    touchstart: function(e) {
        ...
        for (var i = 0; i < e.changedTouches.length; i++) {
            ...
            this.x = touchstartEvent.x = (touch.pageX - this.elementOffset.x -
                this.app.offsetX) / this.app.scale | 0;
            this.y = touchstartEvent.y = (touch.pageY - this.elementOffset.y -
                this.app.offsetY) / this.app.scale | 0;
    ...
    touchend: function(e) {
        ...
        for (var i = 0; i < e.changedTouches.length; i++) {
            ...
            touchendEvent.x = (touch.pageX - this.elementOffset.x -
                this.app.offsetX) / this.app.scale | 0;
            touchendEvent.y = (touch.pageY - this.elementOffset.y -
                this.app.offsetY) / this.app.scale | 0;
...
PLAYGROUND.Utils.extend(PLAYGROUND.Touch.prototype,
    PLAYGROUND.Events.prototype);
        ...
        if (this.current[0] === 'call') {
            ...
            for (var i = 0; i < this.keys.length; i++) {
                ...
                if (typeof properties[key] === 'number') {
                    ...
                    this.before.push(value);
                    this.change.push(PLAYGROUND.Utils.circWrappedDistance(value,
        ...
        for (var i = 0; i < this.keys.length; i++) {
            ...
            switch (this.types[i]) {
                ...
                case 2:
                    ...
                    this.context[key] = PLAYGROUND.Utils.circWrap(this.before[i] +
                        this.change[i] * mod);
...
PLAYGROUND.Utils.extend(PLAYGROUND.Tween.prototype,
    PLAYGROUND.Events.prototype);
...
PLAYGROUND.Application.prototype.loadFontOld = function(name) {
    ...
    styleNode.textContent = '@font-face { font-family: \'' + name + '\'; src: ' +
        sources + ' }';
...
PLAYGROUND.LoadingScreen = {
    ...
    createElements: function() {
        ...
        this.wrapper.style.left = (window.innerWidth / 2 - this.width / 2 | 0) +
            'px';
        this.wrapper.style.top = (window.innerHeight / 2 - this.height / 2 |
            0) + 'px';
