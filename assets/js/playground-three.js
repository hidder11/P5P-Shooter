    ...
    */
    ...
    loadFontItem: function(name) {
        ...
        if (!this.fontStyleSheet) {
            ...
            this.fontStyleSheet = document.styleSheets[document.styleSheets.length -
            1];
        ...
        // if (this.fontStyleSheet.insertRule) {
        ...
        // this.fontStyleSheet.insertRule(rule, this.fontStyleSheet.cssRules.length);

        this.fontStyle.innerHTML += rule;
            ...
            var promise = function(resolve, reject) {
                ...
                var checkingTimer = setInterval(function() {
                    ...
                    var base = cq(100, 32).
                        ...
                        fillStyle('#fff').
                        textBaseline('top').
                        fillText('lorem ipsum dolores sit', 0, 4);
                    var test = cq(100, 32).
                        font('14px \'' + name + '\'').
                        fillStyle('#fff').
                        textBaseline('top').
...
PLAYGROUND.Mouse.prototype = {
    ...
    enableMousewheel: function() {
        ...
        for (var i = eventNames.length; i;) {
            ...
            self.element.addEventListener(eventNames[--i],
...
PLAYGROUND.SoundWebAudioAPI.prototype = {
    ...
    play: function(name, loop) {
        ...
        this.setPosition(bufferSource, this.masterPosition.x,
            this.masterPosition.y, this.masterPosition.z);
